...
lapply(models, summary) # applys function models to all vars in per_s and prints summary output
...
```{r}
# NOTE: must change formula for each imaging var (age+gender for structure, age+gender+meanFD for function)
